...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Self-supervised Depth Estimation on Monocular Endoscopy Dataset -- Evaluation with Geonet',
    ...
    log_root = Path(training_result_root) / "depth_estimation_evaluation_geonet_run_{}_{}_{}_{}_test_id_{}".format(
        currentDT.month,
        currentDT.day,
        currentDT.hour,
        currentDT.minute,
    ...
    scipy.io.savemat(file_name=str(log_root / "geonet_patient_{}.mat".format(testing_patient_id)),
